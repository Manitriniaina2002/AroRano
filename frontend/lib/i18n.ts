...
export const translations: Record<Language, any> = {
  en: {
    ...
    dashboard: {
      ...
      stopPump: 'Stop Pump',
      startingPump: 'Starting pump...',
      stoppingPump: 'Stopping pump...',
      ...
      commandSentStart: 'Pump start command sent',
      commandSentStop: 'Pump stop command sent',
      commandFailed: 'Unable to send fill command',
      commandFailedStart: 'Unable to send pump start command',
      commandFailedStop: 'Unable to send pump stop command',
  ...
  mg: {
    ...
    dashboard: {
      ...
      startPump: 'Alefaso ny paompy',
      stopPump: 'Ajanony ny paompy',
      startingPump: 'Alefa ny paompy...',
      stoppingPump: 'Ajanona ny paompy...',
      ...
      commandSentStart: 'Nalefa ny baiko fampandehanana paompy',
      commandSentStop: 'Nalefa ny baiko fampijanonana paompy',
      commandFailed: 'Tsy afaka nandefa ny baiko famenoana',
      commandFailedStart: 'Tsy afaka nandefa ny baiko fampandehanana paompy',
      commandFailedStop: 'Tsy afaka nandefa ny baiko fampijanonana paompy',
