...
export const translations: Record<Language, any> = {
  ...
  mg: {
    ...
    hardware: {
      ...
      buzzer: { name: 'Fanamafisam-peo', detail: 'Mamoaka fampitandremana amin\'ny feo' },
      ledRGB: { name: 'Jiro RGB', detail: 'Maneho ny toetry ny rafitra' },
      waterPump: { name: 'Paompy rano', detail: 'Mifehy ny fikorianan\'ny rano' },
      relay: { name: 'Relais', detail: 'Mifehy ny herinaratra' },
      esp32: { name: 'ESP32', detail: 'Foiben\'ny rafitra' },
