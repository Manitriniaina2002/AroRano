...
- Environment variables:
  - `NODE_ENV=production`
  - `DATABASE_URL` from your Render Postgres connection string
...
The backend already supports `DATABASE_URL`, so it can connect to Render Postgres without any code changes during deploy.
